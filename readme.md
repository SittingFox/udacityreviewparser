...
1. Download/clone this repository and open the index.html file or open the [live version here](https://sittingfox.github.io/udacityreviewparser/).  (live version is recommended)
